...
class _ResultsScreenState extends State<ResultsScreen> {
  ...
  void initState() {
    ...
    if (resp == null) {
      LocalStorage.loadLastResponse().then((v) {
        if (v != null)
          setState(() => resp = v['response'] as Map<String, dynamic>?);
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    final results =
        resp != null ? resp!['calculated_results'] as List<dynamic> : [];
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      Text('Overall Screening Insight',
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color: _colorFromName(r['color']),
                                        borderRadius: BorderRadius.circular(6)),
                                    child: Text(r['risk_level'],
